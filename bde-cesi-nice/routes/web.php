...
Route::get('/', function(){
    ...
    //user::find(1)->notify(new NotificationAuteurIdee);

    $users = User::find(1);
    Notification::send($users, new NotificationAuteurIdee());
});
...
Route::get('/Boutique/Panier', function(){
    ...
    $users = User::find(1);
    Notification::send($users, new NotificationCommandePassee());
});
...
/*Route::get('/', function(){
    ...
    //user::find(1)->notify(new NotificationNuisance);

    $users = User::find(1);
    Notification::send($users, new NotificationNuisance());
});
*/
