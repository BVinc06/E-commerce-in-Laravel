...
@section('main')
<div class="container">
	 <h1 class="my-4">Liste des événements passés :<a class="btn btn-primary bouton_bleu_head" href="{{ asset('create_event') }}">Ajouter un événement</a></h1>
	 <hr>
$evenementpass = "SELECT * FROM evenements WHERE date_fin_evenement < #DATE( NOW() )#"
 @foreach ($evenements as $evenementpass)
		 <div class="row">
		  	<div class="col-md-7">
